...
plot(times, dt_subset$Global_active_power,type="n", ylab="Global Active Power",xlab="")
lines(times, dt_subset$Global_active_power)

plot(times, dt_subset$Voltage,type="n", ylab="Voltage",xlab="datetime")
lines(times, dt_subset$Voltage)
...
plot(times, dt_subset$Global_reactive_power,type="n", ylab="Global_reactive_power",xlab="datetime")
lines(times, dt_subset$Global_reactive_power)
